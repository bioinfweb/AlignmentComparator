...
/**
 * Source: https://code.google.com/p/himmele/source/browse/trunk/Bioinformatics/NeedlemanWunsch/src/NeedlemanWunsch.java
 * @author Daniel Himmelein, Ben St&ouml;ver (changes)
 */
public class NeedlemanWunsch {
  ...
  public static void main(String [] args) {
          char[] seqA = "ATCGATTATTATTATTACGTTGAC".toCharArray();  //{ 'A', 'C', 'G', 'T', 'C' };
          char[] seqB = "ATCGATTATTATTACGTTGAC".toCharArray();  //{ 'A', 'G', 'T', 'C' };
