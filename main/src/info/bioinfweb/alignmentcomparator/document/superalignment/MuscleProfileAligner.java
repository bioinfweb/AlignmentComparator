...
//			};
    ...
    if (is64BitJRE()) {  //TODO So kann nur festgestellt werden, ob es sich im ein 64 Bit JRE handelt. Wird ein 32 Bit JRE auf einem 64 Bit System ausgef�hrt, wird trotzdem 32 zur�ckgegeben.
    	architecture = "64";
    }
