...
public class MoveCommentEdit extends CommentEdit {
  private CommentAnchor newPosition = null;
  private CommentAnchor oldPosition = null;

  
	public MoveCommentEdit(Document document, Comment comment, CommentAnchor newPosition) {
		super(document, comment);
		this.newPosition = newPosition;
		oldPosition = getComment().getAnchor();
	}
