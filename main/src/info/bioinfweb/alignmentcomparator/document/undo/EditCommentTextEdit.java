...
public class EditCommentTextEdit extends CommentEdit {
	private String otherText;
	
	
	public EditCommentTextEdit(Document document, String newText,	Comment comment) {
	...
	public String getPresentationName() {
		return "Change text for comment at column " + getComment().getAnchor().getFirstPos();
	}
}
